...
@section('title', 'BestMyProject : : Projects Page')
            ...
            <div class="row gx-4 gx-xxl-5 align-items-center">
                <div class="col-xl-6 col-md-6">
                    <div class="page-title-wrapper text-md-start text-center">
                        <h2 class="page-title mb-20">Our Project</h2>
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb list-none justify-content-center justify-content-md-start">
                                <li><a href="/">Home</a></li>
                                <li class="active" aria-current="page">Project </li>
                            </ul>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xxl-10 text-center">
                    <div class="portfolio-menu mb-40" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <button class="gf_btn" data-filter=".cat1">Software</button>
                        <button class="gf_btn" data-filter=".cat2">Web Security</button>
                        <button class="gf_btn" data-filter=".cat3">IT Solutions</button>
                        <button class="gf_btn" data-filter=".cat4">Technology</button>
                        <button class="gf_btn" data-filter=".cat5">Cyber Security</button>
                    </div>
                </div>
            </div>
            <div class="grid row gx-4 gx-xxl-5 feature-slider-one pe-0" data-aos="fade-up" data-aos-delay="200">
                <div class="col-lg-4 col-md-4 col-sm-6 grid-item cat3 cat5">
                    <div class="feature-item mb-40">
                        <a class="back-bg" href="project-details"><img class="w-100" src="{{ asset('frontend/img/work/project-1.jpg') }}" alt="img"></a>
                        <h5>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 grid-item cat2 cat4">
                    <div class="feature-item mb-40">
                        <a class="back-bg" href="project-details"><img class="w-100" src="{{ asset('frontend/img/work/project-2.jpg') }}" alt="img"></a>
                        <h5>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 grid-item cat1 cat5">
                    <div class="feature-item mb-40">
                        <a class="back-bg" href="project-details"><img class="w-100" src="{{ asset('frontend/img/work/project-3.jpg') }}" alt="img"></a>
                        <h5>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 grid-item cat1 cat2">
                    <div class="feature-item mb-40">
                        <a class="back-bg" href="project-details"><img class="w-100" src="{{ asset('frontend/img/work/project-4.jpg') }}" alt="img"></a>
                        <h5>
                            <a href="project-details">Graphic Design</a>
                        </h5>
                        <h3><a href="project-details">Design The Future</a></h3>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 grid-item cat2 cat5">
                    <div class="feature-item mb-40">
                        <a class="back-bg" href="project-details"><img class="w-100" src="{{ asset('frontend/img/work/project-5.jpg') }}" alt="img"></a>
                        <h5>
                            <a href="project-details">Development</a>
                        </h5>
                        <h3><a href="project-details">Web Cycle Develop</a></h3>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 grid-item cat1 cat4">
                    <div class="feature-item mb-40">
                        <a class="back-bg" href="project-details"><img class="w-100" src="{{ asset('frontend/img/work/project-6.jpg') }}" alt="img"></a>
                        <h5>
                            <a href="project-details">Apps Development</a>
                        </h5>
                        <h3><a href="project-details">Company Developmnet</a></h3>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 grid-item cat4">
                    <div class="feature-item mb-40">
                        <a class="back-bg" href="project-details"><img class="w-100" src="{{ asset('frontend/img/work/project-7.jpg') }}" alt="img"></a>
                        <h5>
                            <a href="project-details">App Case Study</a>
                        </h5>
                        <h3><a href="project-details">Full Apps Journey</a></h3>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 grid-item cat3">
                    <div class="feature-item mb-40">
                        <a class="back-bg" href="project-details"><img class="w-100" src="{{ asset('frontend/img/work/project-8.jpg') }}" alt="img"></a>
                        <h5>
                            <a href="project-details">Cyber Engineering</a>
                        </h5>
                        <h3><a href="project-details">Specialized Security</a></h3>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 grid-item cat1">
                    <div class="feature-item mb-40">
                        <a class="back-bg" href="project-details"><img class="w-100" src="{{ asset('frontend/img/work/project-9.jpg') }}" alt="img"></a>
                        <h5>
                            <a href="project-details">Chemical Engineering</a>
                        </h5>
                        <h3><a href="prject-details">World Medicine Care</a></h3>
                    </div>
                </div>
            </div>
            <div class="row">
