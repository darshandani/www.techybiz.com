    ...
    <div class="col-md-12">
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <form id="formAccountSettings" action="{{ route('changepassword')}}" method="POST">
            @csrf
            <div class="row">
            ...
            <div class="row">
              ...
              <div>
                <button type="submit" name="submit" value="submit" class="btn btn-primary me-2">Save changes</button>
